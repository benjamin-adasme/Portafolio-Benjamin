...
p_base +
  ...
  scale_x_continuous(breaks = marcas,
                     labels = percent(abs(marcas))) + 
  labs(title = "La transición demográfica de Chile (1970-2017)",
